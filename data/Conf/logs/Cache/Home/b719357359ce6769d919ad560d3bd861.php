	...
	<div class="Public">
		...
		<div class="Public-box clearfix">
			<ul id="nav_lis" class="case-nav left">
				...
				<li data-index="10" data-hash="#estate"><a href="<?php echo U('Home/Index/fc');?>#estate">微全景360度</a></li>
				<li data-index="11" data-hash="#life"><a href="<?php echo U('Home/Index/fc');?>#life">微支付</a></li>
				...
				<li data-index="15" data-hash="#buy"><a href="<?php echo U('Home/Index/fc');?>#buy">微团购</a></li>
                <li data-index="16" data-hash="#cate"><a href="<?php echo U('Home/Index/fc');?>#cate">微gprs订餐</a></li>
