...
<div class="cLineB">
 ...
 <tr>
	<th style="text-align: left;width: 85px;font-size: 14px;font-weight: bold;line-height: 1.5;padding: 8px 0;"><span class="red"></span>短信接口帐号：</th>
	<td>
		<input type="text" class="px require" style="width:420px;" value="<?php echo ($call["phone_account"]); ?>" name="phone_account">
	</td>	
</tr>
 <tr>
	<th style="text-align: left;width: 85px;font-size: 14px;font-weight: bold;line-height: 1.5;padding: 8px 0;"><span class="red"></span>短信接口密码：</th>
	<td>
		<input type="text" class="px require" style="width:420px;" value="<?php echo ($call["phone_password"]); ?>" name="phone_password">
	</td>	
</tr>
<tr>
	<th style="text-align: left;width: 85px;font-size: 14px;font-weight: bold;line-height: 1.5;padding: 8px 0;"><span class="red"></span>短信接收是否开启：</th>
	<td>
		<label for="statu-1">
			开启
		</label>
