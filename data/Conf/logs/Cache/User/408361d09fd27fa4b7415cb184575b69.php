	...
	<div id="Menu">
		<div class="top">
            ...
            <a>
                ...
                <?php if(in_array(MODULE_NAME,array('Lottery','Coupon','Guajiang','Xitie','Research','Zadan','Xitie'))){ ?>营销功能<?php } ?>
...
<!-- ----------------------------------------------------------------------------------------------------------------------------------------------------- -->
			...
			<div id="TwoMenu-03" <?php if(in_array(MODULE_NAME,array('Lottery','Coupon','Guajiang','Xitie','Zadan','Xitie'))){ ?>style="display:block;" <?php }else{ ?>style="display:none;"<?php } ?> >
...
<!-- ----------------------------------------------------------------------------------------------------------------------------------------------------- -->
            <div class="contab" <?php if(in_array(MODULE_NAME,array('Lottery','Coupon','Guajiang','Xitie','Research','Zadan','Xitie'))){ ?>style="display:block;" <?php }else{ ?>style="display:none;"<?php } ?> >
                     ...
                     <tr>
                       <td colspan="2" align="right">
                         ...
                         <tr>
                           <td>
                           		<?php if($_GET['id']!=''){ ?>
                                    <input type="text" readonly="readonly" class="px"  value="<?php echo ($set["frontpic"]); ?>" name="frontpic" id="small_pic" />
                               <?php }else{ ?>
                                    <input type="text" readonly="readonly" class="px"  value="/tpl/User/default/common/images/panorama/0.jpg" name="frontpic" id="small_pic" />
                               <?php } ?>
                           </td>
                           <td>
                           		<?php if($_GET['id']!=''){ ?>
                                    <input type="text" readonly="readonly" class="px"  value="<?php echo ($set["rightpic"]); ?>" name="rightpic" id="site_map_1" />
                               <?php }else{ ?>
                                    <input type="text" readonly="readonly" class="px"  value="/tpl/User/default/common/images/panorama/1.jpg" name="rightpic" id="site_map_1" />
                               <?php } ?>
                           </td>
                           <td>
                           		<?php if($_GET['id']!=''){ ?>
                                    <input type="text" readonly="readonly" class="px"  value="<?php echo ($set["backpic"]); ?>" name="backpic" id="site_map_2" />
                               <?php }else{ ?>
                                    <input type="text" readonly="readonly" class="px"  value="/tpl/User/default/common/images/panorama/2.jpg" name="backpic" id="site_map_2" />
                               <?php } ?>
                           </td>
                           <td>
                           		<?php if($_GET['id']!=''){ ?>
                                    <input type="text" readonly="readonly" class="px"  value="<?php echo ($set["leftpic"]); ?>" name="leftpic" id="site_map_3" />
                               <?php }else{ ?>
                                    <input type="text" readonly="readonly" class="px"  value="/tpl/User/default/common/images/panorama/3.jpg" name="leftpic" id="site_map_3" />
                               <?php } ?>
                           </td>
                          <td>
                           		<?php if($_GET['id']!=''){ ?>
                                    <input type="text" readonly="readonly" class="px"  value="<?php echo ($set["toppic"]); ?>" name="toppic" id="site_map_4" />
                               <?php }else{ ?>
                                    <input type="text" readonly="readonly" class="px"  value="/tpl/User/default/common/images/panorama/4.jpg" name="toppic" id="site_map_4" />
                               <?php } ?>
                           </td>
                           <td>
                           		<?php if($_GET['id']!=''){ ?>
                                    <input type="text" readonly="readonly" class="px"  value="<?php echo ($set["bottompic"]); ?>" name="bottompic" id="site_map_5" />
                               <?php }else{ ?>
                                    <input type="text" readonly="readonly" class="px"  value="/tpl/User/default/common/images/panorama/5.jpg" name="bottompic" id="site_map_5" />
                               <?php } ?>
                           </td>
                         </tr>
                         <tr>
                           <td align="center"><a href="###" id="upload_small_pic" >上传</a></td>
                           <td align="center"><a href="###" id="upload_site_map_1" >上传</a></td>
                           <td align="center"><a href="###" id="upload_site_map_2" >上传</a></td>
                           <td align="center"><a href="###" id="upload_site_map_3" >上传</a></td>
                           <td align="center"><a href="###" id="upload_site_map_4" >上传</a></td>
                           <td align="center"><a href="###" id="upload_site_map_5" >上传</a></td>
                         </tr>
                       </tbody>
                       </table></td>
                     </tr>
