...
<div class="cLineB">
<h4 class="left">喜帖 (<?php echo ($page); ?> ) </h4>
...
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Xitie/add',array('token'=>$token));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
