...
<tr>
	<td align="center">
		<textarea name="Lastmsg" class="px" id="news2" style="width:200px; height:36px" onblur="document.getElementById(&#39;news&#39;).src=document.getElementById(&#39;news2&#39;).value;"><?php echo ($card["Lastmsg"]); ?></textarea>
	</td>
	<td align="center">
		<textarea name="vip" class="px" id="vippower2" style="width:200px; height:36px" onblur="document.getElementById(&#39;vippower&#39;).src=document.getElementById(&#39;vippower2&#39;).value;"><?php echo ($card["vip"]); ?></textarea>
	</td>
	<td align="center">
		<textarea name="qiandao" class="px" id="qiandao2" style="width:200px; height:36px" onblur="document.getElementById(&#39;qiandao&#39;).src=document.getElementById(&#39;qiandao2&#39;).value;"><?php echo ($card["qiandao"]); ?></textarea>
	</td>
	<td align="center">
		<textarea name="shopping" class="px" id="shopping2" style="width:200px; height:36px" onblur="document.getElementById(&#39;shopping&#39;).src=document.getElementById(&#39;shopping2&#39;).value;"><?php echo ($card["shopping"]); ?></textarea>
	</td>
 </tr>
<tr>
<td></td>
...
<tr>
<td align="center">
	<textarea name="memberinfo" class="px" id="user2" style="width:200px; height:36px" onblur="document.getElementById(&#39;user&#39;).src=document.getElementById(&#39;user2&#39;).value;"><?php echo ($card["memberinfo"]); ?></textarea>
</td>
<td align="center">
	<textarea name="membermsg" class="px" id="info2" style="width:200px; height:36px" onblur="document.getElementById(&#39;info&#39;).src=document.getElementById(&#39;info2&#39;).value;"><?php echo ($card["membermsg"]); ?></textarea>
</td>
<td align="center">
	<textarea name="contact" class="px" id="addr2" style="width:200px; height:36px" onblur="document.getElementById(&#39;addr&#39;).src=document.getElementById(&#39;addr2&#39;).value;"><?php echo ($card["contact"]); ?></textarea>
</td>
<td><button type="submit" name="button" class="btnGreen">保存</button></td>
</tr>
</tbody>
