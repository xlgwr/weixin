...
<td class="norightborder"><a href="<?php echo U('Panorama/set',array('token'=>$token,'id'=>$o['id']));?>">修改</a> <a href="<?php echo U('Panorama/delete',array('id'=>$o['id'],'token'=>$token));?>">删除</a></td>
